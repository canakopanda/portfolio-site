            ...
            {work.subImages.map((sub, idx) => (
              <div key={idx} className="flex flex-col gap-2">
                ...
                <div
                  ...
                  style={!sub.src ? { backgroundColor: work.tagColor + "0d" } : { backgroundColor: (sub.label === "AI使用" || sub.label === "ABテスト用") ? "#f4f4f0" : undefined }}
                >
                  {sub.src ? (
                    <Image
                      src={sub.src}
                      ...
                      fill
                      className={(sub.label === "AI使用" || sub.label === "ABテスト用") ? "object-contain p-2" : "object-cover"}
                    />
                  ) : (
