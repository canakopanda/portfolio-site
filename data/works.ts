...
export const works: Work[] = [
  {
    ...
    client: "ECサイト運営企業",
    overview:
      "GMOコマース在籍中、ECサイト向けのデジタルクリエイティブを一手に担当。季節ごとのキャンペーンバナー、商品LP、LINEリッチメニューの設計まで、購買率向上を目的としたビジュアル制作を継続的に行いました。",
    process:
      "クライアントの販売目標や訴求ポイントをヒアリングし、視線誘導とCTAの配置を意識した設計を心がけました。テンプレートと素材のライブラリ化により品質と速度の両立を実現しました。",
    result:
      "毎月30点以上のクリエイティブを安定納品。バナーのクリック率改善やLP経由のコンバージョン向上に継続的に貢献しました。",
